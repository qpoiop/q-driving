...
export class RoadMesh {
    ...
    constructor(private path: RoadPath, private getHeight: (pos: THREE.Vector3) => number, private halfWidth = 2.5, private offsetY = 0.07) {
    ...
    private createMesh(): THREE.Mesh {
        ...
        const rough = loader.load("/assets/models/road/4k/road001_roughness.jpg")
